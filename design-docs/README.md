...
| [auto-backup.md](./auto-backup.md) | Desktop-only: auto-write daily full-backup JSON to a user-picked folder (30 s debounce on change, keep newest 30) + gzipped `versions/` snapshots (keep newest 50) |
