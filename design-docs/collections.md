...
**Status:** Implemented
**Last updated:** 2026-06-23 (Backlog is no longer a system feature; collection rows support assign/delete)
...
- Cột: **Name · Member · Start · End · Status · Sprint · Actions**. Member là control assign
  trực tiếp; Actions có xoá item với inline confirm. Sprint là menu **Add** để đưa item vào một
  sprint cụ thể.
