...
- Icon: generated by `app/scripts/make-tauri-icon.mjs` (Playwright renders the brand
  ring on a rust `#C04A1A` squircle at 1024px) → `npx tauri icon src-tauri/icon-source.png`
  produces `icons/` (icns + png set).
